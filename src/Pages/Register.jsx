...
const Register = () => {
  ...
  const handleUserSignUp = async (e) => {
    ...
    try {
      ...
      const updatedProfile = await updateUserProfile(name, photo);
                ...
                <form onSubmit={handleUserSignUp}>
                  ...
                  <div className="mt-6">
                    ...
                    <div
                      ...
                      className="flex cursor-pointer items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
                    >
